...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ KR_PICTURE ♥️')
            else:
 ...
 if query.data.startswith("file"):
    ...
    try:
        ...
        await query.answer('Sᴜᴘᴘᴏʀᴛ KR_PICTURE')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⏹️ Buttons', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I Cᴏᴜʟᴅɴ'ᴛ Fɪɴᴅ Aɴʏ Mᴏᴠɪᴇ, Mᴏᴠɪᴇ RᴇQᴜᴇꜱᴛ Aᴄᴄᴇᴘᴛᴇᴅ, Mᴏᴠɪᴇ Aᴠᴀɪʟᴀʙʟᴇ Sᴏᴏɴ.")
